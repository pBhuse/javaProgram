...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(Project.class.getResource("/images/main.jpg")));
        ...
        JLabel l1 = new JLabel(new ImageIcon(Project.class.getResource("/images/main.jpg")));
        ...
        m1.setIcon(new ImageIcon(Project.class.getResource("/images/icon1.jpg")));
       ...
       // JMenuItem m3 = new JMenuItem("Deposit Details");
        ...
        m2.setIcon(new ImageIcon(Project.class.getResource("/images/icon2.png")));
        m2.setMnemonic('M');
...
//        m3.setIcon(new ImageIcon(Project.class.getResource("/images/icon3.png")));
//
...
//        m3.addActionListener(this);
        ...
        u1.setIcon(new ImageIcon(Project.class.getResource("/images/icon4.png")));
        u1.setMnemonic('P');
        ...
        u2.setIcon(new ImageIcon(Project.class.getResource("/images/icon5.png")));
        u2.setMnemonic('B');
        ...
        u3.setIcon(new ImageIcon(Project.class.getResource("/images/icon6.png")));
        u3.setMnemonic('L');
        ...
        r1.setIcon(new ImageIcon(Project.class.getResource("/images/icon7.png")));
        r1.setMnemonic('R');
        ...
        ut1.setIcon(new ImageIcon(Project.class.getResource("/images/icon12.png")));
        ut1.setMnemonic('C');
        ...
        ut2.setIcon(new ImageIcon(Project.class.getResource("/images/icon9.png")));
        ut2.setMnemonic('X');
        ...
        ut3.setIcon(new ImageIcon(Project.class.getResource("/images/icon10.png")));
        ut3.setMnemonic('W');
        ...
        ex.setIcon(new ImageIcon(Project.class.getResource("/images/icon11.png")));
        ex.setMnemonic('Z');
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("Customer Details")){
            ...
            try{
                Runtime.getRuntime().exec("https://www.google.com/intl/en_in/chrome/");
            }catch(Exception e){ }
